...
metadata = {
    "apiLevel": "2.20",
    "protocolName": "BOTany3A-MoClo",
    "description": """Golden Gate DNA assembly (e.g. Plant MoClo) using on-deck thermocycler.""",
...
def add_parameters(parameters):
    parameters.add_csv_file(variable_name="svt_csv",
                       display_name="BOTany3-MoClo-Table CSV File",
    ...
    parameters.add_str(
        ...
        description="If you attached another pipette on the robot that will not be used in this protocol",
        choices=[
    ...
    #Parameter to choose the location of the extraneous pipette
    parameters.add_str(
    variable_name="pipette_ext_loc",
    display_name="Other Pipette Location",
    description="The location of the extraneous pipette, left or right",
    choices=[
        {"display_name": "Left", "value": "left"},
        {"display_name": "Right", "value": "right"},
    ],
    ...
    parameters.add_int(
        ...
        display_name="Digest-Ligate Cycles",
        description="digest-ligate cycle number",
        default=5,
        minimum=1,
        maximum=99,
    )
    ...
    parameters.add_int(
        ...
        display_name="Digestion Minutes",
        description="minutes of digestion per digest-ligate cycle",
        default=10,
        unit="minutes",
        minimum=1,
        maximum=99,
    ...
    parameters.add_int(
        ...
        display_name="Ligation Temperature",
        description="ligation temperature, 16 or 22",
        default=22,
        unit="Celsius",
        choices=[
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for _ in range(protocol.params.tc_mod_cycles):
        tc_mod.set_block_temperature(temperature=37, hold_time_minutes=5) #Set thermocycler temp to 37 degrees Celsius for 5 mins
        #Defined in runtime parameters, Set thermocycler temp to _ degrees Celsius for _ mins
        tc_mod.set_block_temperature(temperature=protocol.params.tc_mod_temp, hold_time_minutes=protocol.params.tc_mod_minutes)

    tc_mod.set_block_temperature(temperature=37, hold_time_minutes=5) #Set thermocycler temp to 37 degrees Celsius for 5 mins
    tc_mod.set_block_temperature(temperature=75, hold_time_minutes=10) #Set thermocycler temp to 37 degrees Celsius for 5 mins
